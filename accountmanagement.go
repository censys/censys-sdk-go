...
// GetOrganizationCredits - Get organization credit details
...
func (s *AccountManagement) RemoveOrganizationMember(ctx context.Context, request operations.V3AccountmanagementRemoveOrgMemberRequest, opts ...operations.Option) (*operations.V3AccountmanagementRemoveOrgMemberResponse, error) {
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"401", "403", "404", "409", "422", "4XX", "5XX"}, httpRes.StatusCode) {
			_httpRes, err := s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, httpRes, nil)
			if err != nil {
				return nil, err
			} else if _httpRes != nil {
...
// GetMemberCreditUsage - Get member credit usage
...
// GetUserCredits - Get Free user credit details
