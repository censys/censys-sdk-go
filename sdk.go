...
// Generated from OpenAPI doc version 1.0.15 and generator version 2.658.3
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.18.5",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.18.5 2.658.3 1.0.15 github.com/censys/censys-sdk-go",
