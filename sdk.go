...
// Generated from OpenAPI doc version 1.0.21 and generator version 2.666.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.19.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.19.0 2.666.0 1.0.21 github.com/censys/censys-sdk-go",
