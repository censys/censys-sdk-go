...
// Generated from OpenAPI doc version 1.0.122 and generator version 2.918.4
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.25.25",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.25.25 2.918.4 1.0.122 github.com/censys/censys-sdk-go",
