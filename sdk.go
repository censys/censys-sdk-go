...
// Generated from OpenAPI doc version 1.0.54 and generator version 2.788.7
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.25.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.25.2 2.788.7 1.0.54 github.com/censys/censys-sdk-go",
