...
// Generated from OpenAPI doc version 1.0.63 and generator version 2.793.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.25.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.25.3 2.793.0 1.0.63 github.com/censys/censys-sdk-go",
