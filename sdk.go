...
// Generated from OpenAPI doc version 1.0.65 and generator version 2.797.1
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.25.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.25.3 2.797.1 1.0.65 github.com/censys/censys-sdk-go",
