...
// Generated from OpenAPI doc version 1.0.69 and generator version 2.801.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.25.4",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.25.4 2.801.0 1.0.69 github.com/censys/censys-sdk-go",
