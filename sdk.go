...
// Generated from OpenAPI doc version 1.0.123 and generator version 2.924.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.25.26",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.25.26 2.924.0 1.0.123 github.com/censys/censys-sdk-go",
