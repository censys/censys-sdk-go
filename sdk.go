...
// Generated from OpenAPI doc version 1.0.138 and generator version 2.941.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.26.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:         "speakeasy-sdk/go 0.26.0 2.941.0 1.0.138 github.com/censys/censys-sdk-go",
			SDKVersion:        "0.26.0",
			GenVersion:        "2.941.0",
