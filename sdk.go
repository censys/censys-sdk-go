...
// Generated from OpenAPI doc version 1.0.76 and generator version 2.835.2
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.25.6",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.25.6 2.835.2 1.0.76 github.com/censys/censys-sdk-go",
