...
// Generated from OpenAPI doc version 1.0.29 and generator version 2.677.3
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.20.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.20.0 2.677.3 1.0.29 github.com/censys/censys-sdk-go",
