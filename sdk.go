...
// Generated from OpenAPI doc version 1.0.40 and generator version 2.714.0
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.22.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.22.1 2.714.0 1.0.40 github.com/censys/censys-sdk-go",
