...
// Generated from OpenAPI doc version 1.0.35 and generator version 2.690.1
...
func New(opts ...SDKOption) *SDK {
	sdk := &SDK{
		SDKVersion: "0.20.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.20.0 2.690.1 1.0.35 github.com/censys/censys-sdk-go",
